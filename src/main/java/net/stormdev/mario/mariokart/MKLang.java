...
public class MKLang {
	...
	private void load(){
		...
		if (!lang.contains("race.que.notEnoughPlayers")) {
			lang.set(
					"race.que.notEnoughPlayers", "Not enough players for this track! Restarting vote...");
		}
		...
		if (!lang.contains("server.spectator.teleportToPlayer")) {
			lang.set("server.spectator.teleportToPlayer", "You have been teleportet to %name%!");
		}
